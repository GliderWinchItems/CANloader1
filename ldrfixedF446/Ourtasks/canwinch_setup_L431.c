/******************************************************************************
* File Name          : canwinch_setup_L431.c
...
0,		/* port: port: 0 = PA 11|12; 1 = PB; 2 = PD 0|1;  (port > 2 is not valid)  */
...
5,		/* tbs1: CAN_BTR[19:16] Time segment 1 (e.g. 12) */
...
*******************************************************************************/
static int canwinch_setup_L431_filter(u32 canid)
{
...
struct CAN_CTLBLOCK* canwinch_setup_L431(const struct CAN_INIT* pinit, u32 canid)
{
	...
	int ret = canwinch_setup_L431_filter(canid);
